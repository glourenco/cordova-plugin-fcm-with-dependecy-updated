...
DESC
  ...
  spec.homepage     = "https://github.com/glourenco/cordova-plugin-fcm-with-dependecy-updated"
  ...
  spec.author = { "Goncalo Lourenco" => "gon.lourenco@gmail.com" }
  # Or just: spec.author    = ""
  ...
  spec.source       = { :git => "https://github.com/glourenco/cordova-plugin-fcm-with-dependecy-updated.git", :tag => "v#{spec.version}" }
